  ...
  return (
    <div className='flex h-[500px]'>
        <div className='flex-1 h-full bg-[#f7f7f7]'>
          <div className='hover:scale-110 transition-all duration-300 flex flex-col h-full justify-center gap-5 items-center text-center'>
        ...
        <div className='flex-1 text-white h-full bg-primaryOrange'>
          <div className='hover:scale-110 transition-all duration-300 flex flex-col justify-center gap-5 items-center text-center h-full'>
        ...
        <div className='flex-1 h-full bg-[#f7f7f7]'>
          <div className='flex flex-col justify-center gap-5 items-center text-center h-full hover:scale-110 transition-all duration-300'>
            <img src={paintVector} alt="paintVector" className='h-[120px]'/>
