export default function Hero() {
  return (
    <main className='flex flex-col justify-center text-white items-center pb-24'>
      <h1 className='text-[86px] mt-14 font-bold text-primaryOrange'>
        <span className='font-sans'>2022</span>PAINTING
      </h1>
      <p className='text-[32px] font-[500]'>Exterior and interior Painting</p>
      ...
      <div className='flex gap-10 mt-10'>
        <a className='py-3 px-8 transition-colors duration-300 text-white bg-primaryOrange hover:bg-orange-600' href="">Learn more</a>
        <a className='py-3 px-8 transition-colors duration-300 text-black bg-white hover:bg-primaryOrange hover:border-transparent hover:text-white' href="">Contact us</a>
      </div>
    </main>
  )
}
